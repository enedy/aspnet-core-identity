...
using AspnetCoreIdentity.Identity.PolicyRequirements;
...
namespace AspnetCoreIdentity.Api.Extensions
{
    public static class AuthenticationExtensions
    {
        ...
        {
            services.AddSingleton<IAuthorizationHandler, CommercialTimeHandler>();
            services.AddAuthorization(options =>
            {
                options.AddPolicy(Policies.CommercialTime, policy =>
                    policy.Requirements.Add(new CommercialTimeRequirement()));
            });
        }
    }
}
